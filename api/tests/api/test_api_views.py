...
class ViewSetPermissionsTest(APILoginTestCase):
    ...
    def test_superuser_has_full_access(self):
        ...
        superuser = User.objects.create_superuser(username="admin", email="admin@example.com", password="adminpass")
...
class ViewSetValidationTest(APILoginTestCase):
    ...
    def test_create_with_invalid_data(self):
        ...
        response = self.client.post("/api/v1/certificates", {"invalid_field": "value"}, format="json")
    ...
    def test_update_with_invalid_data_cert_not_found(self):
        ...
        response = self.client.put("/api/v1/certificates/1", {"invalid_field": "value"}, format="json")
    ...
    def test_update_with_invalid_data(self):
        ...
        certificate.save()
        response = self.client.put(f"/api/v1/certificates/{certificate.id}", {"invalid_field": "value"}, format="json")

        self.assertIn(response.status_code, [status.HTTP_405_METHOD_NOT_ALLOWED])

    def test_create_with_missing_required_fields(self):
        """Test create zonder verplichte velden"""
        response = self.client.post("/api/v1/certificates", {}, format="json")
...
class ViewSetFilteringTest(APILoginTestCase):
    ...
    def test_filter_by_date_range(self):
        ...
        certificate = CertificateFactory(owner=self.user)
        certificate.save()
        response = self.client.get("/api/v1/certificates?created_at__gte=2024-01-01")
...
class ViewSetPaginationTest(APILoginTestCase):
    ...
    def test_pagination_invalid_page(self):
        ...
        self.assertIn(response.status_code, [status.HTTP_200_OK, status.HTTP_404_NOT_FOUND])  # Lege results
...
class ViewSetExceptionHandlingTest(APILoginTestCase):
    ...
    def test_unsupported_media_type(self):
        ...
        response = self.client.post("/api/v1/certificates/", data="invalid xml data", content_type="application/xml")

        if response.status_code not in [status.HTTP_404_NOT_FOUND]:
            self.assertIn(response.status_code, [status.HTTP_415_UNSUPPORTED_MEDIA_TYPE, status.HTTP_400_BAD_REQUEST])
