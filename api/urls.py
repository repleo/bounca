...
urlpatterns_apiv1 = [
    ...
    path("certificates/<int:pk>/key", CertificateKeyView.as_view(), name="certificate-key"),
    ...
    path("account/", AccountViewSet.as_view({"get": "retrieve", "delete": "destroy"}), name="account"),
]
