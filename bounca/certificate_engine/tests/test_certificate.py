...
from cryptography.x509.extensions import _key_identifier_from_public_key, ExtensionNotFound
...
from bounca.x509_pki.tests.factories import CertificateFactory
...
class CertificateTest(CertificateTestCase):
    ...
    def test_store_root_certificate(self):
        ...
        crt = certhandler.read_certificate('test_root_Ca.pem')
