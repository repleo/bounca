...
#        help_text=password_validation.password_validators_help_text_html(),
    ...
    def clean_passphrase_out_confirmation(self):
        passphrase_out = self.cleaned_data.get("passphrase_out")
        passphrase_out_confirmation = self.cleaned_data.get("passphrase_out_confirmation")
    ...
    def clean(self):
        ...
        if Certificate.objects.filter(dn=dn, type=cert_type, revoked_uuid='00000000000000000000000000000001').count() > 0:
