# Generated by Django 3.0.6 on 2020-05-09 10:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countryName', django_countries.fields.CountryField(help_text='The two-character country name in ISO 3166 format.', max_length=2, verbose_name='Country Name')),
                ('stateOrProvinceName', models.CharField(help_text="The state/region where your organization is located. This shouldn't be abbreviated. (1–128 characters)", max_length=128, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z@#$%^&+=\\_\\.\\-\\,\\ \\*]*$', 'Only alphanumeric characters and [@#$%^&+=_,-.] are allowed.')], verbose_name='State or Province Name')),
                ('localityName', models.CharField(help_text='The city where your organization is located. (1–128 characters)', max_length=128, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z@#$%^&+=\\_\\.\\-\\,\\ \\*]*$', 'Only alphanumeric characters and [@#$%^&+=_,-.] are allowed.')], verbose_name='Locality Name')),
                ('organizationName', models.CharField(help_text='The legal name of your organization. This should not be abbreviated and should include suffixes such as Inc, Corp, or LLC.', max_length=64, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z@#$%^&+=\\_\\.\\-\\,\\ \\*]*$', 'Only alphanumeric characters and [@#$%^&+=_,-.] are allowed.')], verbose_name='Organization Name')),
                ('organizationalUnitName', models.CharField(help_text='The division of your organization handling the certificate.', max_length=64, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z@#$%^&+=\\_\\.\\-\\,\\ \\*]*$', 'Only alphanumeric characters and [@#$%^&+=_,-.] are allowed.')], verbose_name='Organization Unit Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateField(help_text='Select the date that the certificate will expire: for root typically 20 years, for intermediate 10 years for other types 1 year. Allowed date format: yyyy-mm-dd.', validators=[x509_pki.models.validate_in_future])),
                ('revoked_at', models.DateField(blank=True, default=None, editable=False, null=True)),
                ...
                ('dn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='x509_pki.DistinguishedName')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('parent', models.ForeignKey(blank=True, help_text='The signing authority (None for root certificate)', null=True, on_delete=django.db.models.deletion.CASCADE, to='x509_pki.Certificate')),
            ],
            options={
