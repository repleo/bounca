    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crl_distribution_url', models.URLField(blank=True, help_text='Base URL for certificate revocation list (CRL)', null=True, validators=[django.core.validators.RegexValidator('[^\\/]\\.crl\\.pem$', 'CRL url shoud end with <filename>.crl')], verbose_name='CRL distribution url')),
